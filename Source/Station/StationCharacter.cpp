...
AStationCharacter::AStationCharacter()
{
...
void AStationCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent))
	{
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &AStationCharacter::Move);

		// Looking
		EnhancedInputComponent->BindAction(LookAction, ETriggerEvent::Triggered, this, &AStationCharacter::Look);
	}
	else
	{
...
void AStationCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void AStationCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void AStationCharacter::SetHasRifle(bool bNewHasRifle)
{
